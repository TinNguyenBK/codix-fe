...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this._matIconRegistry.addSvgIcon(
      'adviserplus',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/Adviser plus.svg'
      )
    );
    ...
    this._matIconRegistry.addSvgIcon(
      'supervisoraccount',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/Supervisor Account.svg'
      )
    );
    ...
    this._matIconRegistry.addSvgIcon(
      'credic-card',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/Credit Card.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'messages-order',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/Messages-order.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'phone-order',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/Phone-order-summary.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'phone',
    ...
    this._matIconRegistry.addSvgIcon(
      'branch-manager',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/ic_business_24px.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'widgets',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/ic_widgets_24px.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'report',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/report.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'shipping_policy',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/truck.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'pivacy',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/privacy-policy.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'customers',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/Account box.svg'
      )
    );
    this._matIconRegistry.addSvgIcon(
      'customer',
      this._domSanitizer.bypassSecurityTrustResourceUrl(
        '../assets/icons/ICON/customer.svg'
      )
    );
  }
  ...
  ngOnInit(): void {
    ...
    if ((navigator as any).standalone === undefined) {
      //It's an iOS device
      if (
        window.matchMedia('(display-mode: browser) and (max-width: 1100px)')
          .matches
      ) {
        //Window in browser
        window.addEventListener('beforeinstallprompt', (event) => {
          ...
          const sb = this._snackBar.open(
            'Do you want to install Thermomix ?',
            'Install',
            { duration: 5000 }
          );
          sb.onAction().subscribe(() => {
