...
@Component({
  selector: 'app-register-supplier-done',
  templateUrl: './register-supplier-done.component.html',
  styleUrls: ['./register-supplier-done.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class RegisterSupplierDoneComponent implements OnInit {
 ...
 // advisor_id: string;
  ...
  ngOnInit(): void {
    ...
    this.returnUrl = this.activatedRoute.snapshot.queryParams['email'];
    // if (!this.returnUrl)
