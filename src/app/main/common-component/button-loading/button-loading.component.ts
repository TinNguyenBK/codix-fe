...
export class ButtonLoadingComponent implements OnChanges {
 ...
 @Input() buttonText: string = '';
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (this.buttonName ===  "Click here to complete payment "){
      this.barButtonOptions.customClass = this.disabledBtn ? 'btn-pay-at-office-2 btn-active' : 'btn-pay-at-office-2 btn-disabled';
    }
    ...
    if (this.buttonName ===  "Thêm thông tin riêng"){
    ...
    if (this.buttonName ===  "Sửa thông tin chung"){
    ...
    if (this.buttonName === "DOWNLOAD INVOICE"){
      this.barButtonOptions.customClass = this.disabledBtn ? 'btn-download-invoice btn-active' : 'btn-buy-package btn-disabled';
    }
    if (this.buttonName === "I have received my order"){
      this.barButtonOptions.customClass = this.disabledBtn ? 'btn-received-now btn-active' : 'btn-buy-package btn-disabled';
    }
